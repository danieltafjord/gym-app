...
class MembershipResumedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->template
            ...
            : "Your {$this->membership->plan->name} membership has been resumed";
    ...
    private function defaultBody(): string
    {
        return "Hi {$this->membership->customer_name},\n\n"
            ."Your {$this->membership->plan->name} membership has been resumed.\n\n"
            .'Welcome back! You can now access the gym as usual.';
    }
}
